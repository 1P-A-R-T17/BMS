...
MODEL                = Drdo_sim_2
MODULES              = rt_matrx.c rt_printf.c rt_logging_simtarget.c Drdo_sim_2.c Drdo_sim_2_capi.c Drdo_sim_2_data.c Drdo_sim_2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
PRODUCT              = Drdo_sim_2.exe
MAKEFILE             = Drdo_sim_2.mk
MATLAB_ROOT          = C:/Program Files/Polyspace/R2021a
ALT_MATLAB_ROOT      = C:/PROGRA~1/POLYSP~1/R2021a
START_DIR            = D:/bms_final_year/BMS/Simulation
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\wsock32.lib
NUMST                = 4
NCSTATES             = 21
BUILDARGS            =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="C:\\Program Files\\Polyspace\\R2021a" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Drdo_sim_2 \
